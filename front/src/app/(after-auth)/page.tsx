...
const DummyData: ProjectRes[] = [
  {
    projectId: 1, projectName: '스타트 프로젝트, 스프',
    projectImageUri: faker.image.urlPicsumPhotos(),
    projectMemberImageUris: Array.from({ length: 3 }, () => ({ projectMemberImageUri: faker.image.avatarGitHub() })),
  }, {
    projectId: 2,
    projectName: '멋진승원',
    projectImageUri: faker.image.urlPicsumPhotos(),
      ...
      <div className={styles.content}>
        <p>내 프로젝트</p>
          <div className={styles.projects}>
            {DummyData.map(data => <Project {...data} />)}
          </div>
    </div>
</div>
  )
