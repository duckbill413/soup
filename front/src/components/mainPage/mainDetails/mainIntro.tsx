...
import * as styles from "@/styles/main/mainIntro.css"
    ...
    return (
        <div className={styles.container}>
          <div className={styles.mainDiv}>
            ...
            <p className={styles.subTitle}>Spring 프레임워크 기반 프로젝트의 기획, 설계가</p>
            ...
            <button type="button" className={bounceAnimation} onClick={onButtonClick} aria-label="내려가기">
              <DownButton />
            </button>
