...
import * as styles from '@/styles/project/navigation.css';
    ...
    <div className={styles.container}>
      {iconPathMapping.map(({ icon: Icon, path: iconPath, name }, index) => (
        <React.Fragment key={iconPath}>
          ...
          <Link href={`${parentPath}${iconPath}`} style={{ textDecoration: "none", color: 'white'}}>
          <div
            ...
            <Icon
              color={
                hoverIndex === index ? vars.color.black : path.includes(iconPath) ? vars.color.lightGreen : vars.color.white
              }
            />
