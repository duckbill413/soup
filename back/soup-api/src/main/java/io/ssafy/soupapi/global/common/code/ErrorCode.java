...
public enum ErrorCode {
    ...
    OPENVIDU_SERVER_ERROR(500,"B802","Openvidu 서버에 연걸되지 않습니다."),
    NOT_FOUND_CONNECTION(404,"B803","Openvidu Connection 찾을 수 없습니다."),
    ...
    NEED_PROJECT_BUILD_INFO(404, "B1101", "프로젝트 정보가 필요합니다."),
    NEED_PROJECT_BUILD_APIDOC(404, "B1102", "프로젝트 API DOC가 필요합니다."),
    ...
    // README 에러 (CODE: 1300)
    FAILED_TO_UPDATE_README(404, "B1300", "Liveblocks Readme 업데이트 실패"),

    // Flow Chart 에러 (CODE: 1400)
    FAILED_TO_UPDATE_FLOWCHART(404, "B1400", "Liveblocks Flow Chart 업데이트 실패"),
    ; // End
